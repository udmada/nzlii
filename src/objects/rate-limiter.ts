 ...
 *
 * Exposes a single HTTP endpoint (any path):
 *   200 OK  — slot acquired, caller may proceed
 *   503     — backlog too deep, caller should retry messages with a delay
 *
